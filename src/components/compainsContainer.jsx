                  ...
                  <td className="srcipp">
                    <div className="statuscontainer">
                      <p
                        ...
                        style={{
                          backgroundColor: campaign.status === "Moderation" && "#004b70",
                          color: campaign.status === "Moderation" && "#b1deeb",
                          padding: campaign.status === "Moderation" && "5px 8px",
                          borderRadius: campaign.status === "Moderation" && "5px",
